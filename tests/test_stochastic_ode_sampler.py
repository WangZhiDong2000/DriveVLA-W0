...
def test_eps_clamp_enforced():
    ...
    _, _, _, eps, _ = stochastic_euler_step(z, v, DT, Q01, Q99, sigma_step=0.04, generator=g)
...
def test_reproducibility_same_seed():
    ...
    z1, lp1, zm1, e1, _ = stochastic_euler_step(z, v, DT, Q01, Q99, generator=g1)
    z2, lp2, zm2, e2, _ = stochastic_euler_step(z, v, DT, Q01, Q99, generator=g2)
...
def test_monte_carlo_mean_converges_to_z_mean():
    ...
    for s in range(N):
        ...
        z_next, _, z_mean, _, _ = stochastic_euler_step(z, v, DT, Q01, Q99, generator=g)
        accum += z_next
        z_mean_ref = z_mean
    mc_mean = accum / N
...
def test_eps_shape_and_clamp_large_sigma():
    ...
    _, _, _, eps, _ = stochastic_euler_step(z, v, DT, Q01, Q99, sigma_step=0.5, generator=g)
...
def test_log_prob_finite_100_batches():
    ...
    for s in range(100):
        ...
        _, lp, _, _, _ = stochastic_euler_step(z, v, DT, Q01, Q99, generator=g)
